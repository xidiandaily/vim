...
" if !exists("g:SSHSendRemot")
"  let g:BOYFTPTopLvlMenu= "DrChip."
" endif
" exe 'menu '.g:BOYFTPTopLvlMenu.'DrawIt.Start\ DrawIt<tab>\\di		<Leader>di'
"endif
"
"if has("gui_running") && has("menu") && &go =~ 'm'
" if !exists("g:SSHSendRemot")
"  let g:BOYFTPTopLvlMenu= "BoyaaFTP."
" endif
" exe 'menu '.g:BOYFTPTopLvlMenu.'Send\'
"endif
...
" endif
" exe 'menu '.g:DrChipTopLvlMenu.'DrawIt.Start'
"endif
"
"" ---------------------------------------------------------------------
""
